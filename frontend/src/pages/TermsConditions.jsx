      ...
      <section className='relative flex flex-col items-center justify-center pt-[100px] md:pt-[160px] lg:pt-[180px] xl:pt-[220px]'>
        ...
        <div className='mx-auto my-10 max-w-6xl rounded-xl bg-white px-4 py-8 shadow-lg md:p-8'>
          ...
          <p>
            ...
            subject to, prevailing law of de. Any use of the above terminology
          ...
          <p>
            ...
            the intellectual property rights for all material on Bio Baum Bauer.
            All intellectual property rights are reserved. You may access this
            from Bio Baum Bauer for your own personal use subjected to
          ...
          <p>
            ...
            views and opinions of Solawi Zabergäu,its agents and/or affiliates.
            ...
            Solawi Zabergäu shall not be liable for the Comments or for any
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Solawi
            Zabergäu; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to Solawi Zabergäu. Please include your name, your
