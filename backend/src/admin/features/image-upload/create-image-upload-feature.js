...
const createImageUploadFeature = ({
  folder,
  properties = {},
  validation = {},
} = {}) => {
  if (!folder) {
    throw new Error('createImageUploadFeature requires a folder name');
  }
  ...
  return uploadFeature({
    ...
    uploadPath: (record, filename) => {
      ...
      return `${folder}/${idPart}/${Date.now()}-${safeName}`;
    },
...
export default createImageUploadFeature;
